 ...
 * @author LUCAS
 */
public class Interfaz_Esqueleto extends javax.swing.JFrame {
    private int mouseX;
    private int mouseY;
    private boolean maximized = true;
    
    public Interfaz_Esqueleto() {
        initComponents();
        ...
        setExtendedState(Interfaz_Esqueleto.MAXIMIZED_BOTH);
    ...
    private void btnMaximizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaximizarActionPerformed
        if (maximized) {
        setExtendedState(Interfaz_Esqueleto.NORMAL);
        btnMaximizar.setText("□");
    ...
    private void btnMinimizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimizarActionPerformed
        setState(Interfaz_Esqueleto.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interfaz_Esqueleto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaz_Esqueleto().setVisible(true);
            }
        });
    }
